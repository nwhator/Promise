...
<style>
        .syntax-kw { color: #259df4; } /* Keywords like def, class, return, import */
        .syntax-dec { color: #eab308; } /* Decorators @app.get */
        .syntax-str { color: #22c55e; } /* Strings "Hello" */
        .syntax-fn { color: #60a5fa; }  /* Function names */
        .syntax-type { color: #a855f7; } /* Types str, int, BaseModel */
        .syntax-cls { color: #facc15; }  /* Class names */
        ...
        @media print {
            ...
            .code-block { border: 1px solid #ccc; background: #f5f5f5 !important; color: black !important; }
            header, footer, button { display: none !important; }
            .layout-content-container { max-width: 100% !important; margin: 0 !important; padding: 0 !important; }
        }
    </style>
...
<p class="text-xs text-slate-500 dark:text-slate-500">
                    Join 4,000+ developers. No spam, just high-quality backend tips.
                </p>
</div>
...
<h3 class="text-2xl font-bold text-white mb-2">Build Faster APIs</h3>
<p class="text-slate-400">Production-ready patterns at your fingertips.</p>
</div>
</div>
</div>
</section>
...
<button class="p-2 text-slate-400 hover:text-white transition-colors" title="Print View">
<span class="material-symbols-outlined">print</span>
</button>
<button class="p-2 text-slate-400 hover:text-white transition-colors" title="Copy Link">
...
<div class="p-0 bg-code-bg overflow-x-auto custom-scrollbar flex-grow code-block">
<pre class="font-mono text-sm leading-6 p-4 text-slate-300"><span class="text-slate-500 select-none mr-3">1</span><span class="syntax-kw">from</span> typing <span class="syntax-kw">import</span> Union
<span class="text-slate-500 select-none mr-3">2</span><span class="syntax-kw">from</span> fastapi <span class="syntax-kw">import</span> FastAPI
<span class="text-slate-500 select-none mr-3">3</span>
<span class="text-slate-500 select-none mr-3">4</span>app = <span class="syntax-cls">FastAPI</span>()
<span class="text-slate-500 select-none mr-3">5</span>
<span class="text-slate-500 select-none mr-3">6</span><span class="syntax-dec">@app.get</span>(<span class="syntax-str">"/"</span>)
<span class="text-slate-500 select-none mr-3">7</span><span class="syntax-kw">async def</span> <span class="syntax-fn">read_root</span>():
<span class="text-slate-500 select-none mr-3">8</span>    <span class="syntax-kw">return</span> {<span class="syntax-str">"Hello"</span>: <span class="syntax-str">"World"</span>}
<span class="text-slate-500 select-none mr-3">9</span>
<span class="text-slate-500 select-none mr-3">10</span><span class="syntax-dec">@app.get</span>(<span class="syntax-str">"/items/{item_id}"</span>)
<span class="text-slate-500 select-none mr-3">11</span><span class="syntax-kw">async def</span> <span class="syntax-fn">read_item</span>(item_id: <span class="syntax-type">int</span>, q: Union[<span class="syntax-type">str</span>, <span class="syntax-kw">None</span>] = <span class="syntax-kw">None</span>):
...
<div class="p-0 bg-code-bg overflow-x-auto custom-scrollbar flex-grow code-block">
<pre class="font-mono text-sm leading-6 p-4 text-slate-300"><span class="syntax-kw">from</span> pydantic <span class="syntax-kw">import</span> BaseModel

<span class="syntax-kw">class</span> <span class="syntax-cls">Item</span>(<span class="syntax-cls">BaseModel</span>):
    name: <span class="syntax-type">str</span>
    description: <span class="syntax-type">str</span> | <span class="syntax-kw">None</span> = <span class="syntax-kw">None</span>
    price: <span class="syntax-type">float</span>
    tax: <span class="syntax-type">float</span> | <span class="syntax-kw">None</span> = <span class="syntax-kw">None</span>

<span class="syntax-dec">@app.post</span>(<span class="syntax-str">"/items/"</span>)
<span class="syntax-kw">async def</span> <span class="syntax-fn">create_item</span>(item: <span class="syntax-cls">Item</span>):
    <span class="syntax-kw">return</span> item
</pre>
</div>
</div>
...
<div class="p-0 bg-code-bg overflow-x-auto custom-scrollbar flex-grow code-block">
<pre class="font-mono text-sm leading-6 p-4 text-slate-300"><span class="text-slate-500 text-xs mb-2 block">// Path Param: {item_id}</span>
<span class="syntax-dec">@app.get</span>(<span class="syntax-str">"/items/{item_id}"</span>)
<span class="syntax-kw">def</span> <span class="syntax-fn">read_item</span>(item_id: <span class="syntax-type">int</span>):
    <span class="syntax-kw">pass</span>

<span class="text-slate-500 text-xs mb-2 mt-4 block">// Query Param: ?skip=0&amp;limit=10</span>
<span class="syntax-dec">@app.get</span>(<span class="syntax-str">"/items/"</span>)
<span class="syntax-kw">def</span> <span class="syntax-fn">read_items</span>(
    skip: <span class="syntax-type">int</span> = 0, 
    limit: <span class="syntax-type">int</span> = 10
):
    <span class="syntax-kw">return</span> db[skip : skip + limit]
</pre>
</div>
</div>
...
<div class="p-0 bg-code-bg overflow-x-auto custom-scrollbar flex-grow code-block">
<pre class="font-mono text-sm leading-6 p-4 text-slate-300"><span class="syntax-kw">from</span> fastapi <span class="syntax-kw">import</span> Depends

<span class="syntax-kw">async def</span> <span class="syntax-fn">common_params</span>(
    q: <span class="syntax-type">str</span> | <span class="syntax-kw">None</span> = <span class="syntax-kw">None</span>, 
    skip: <span class="syntax-type">int</span> = 0, 
    limit: <span class="syntax-type">int</span> = 100
):
    <span class="syntax-kw">return</span> {<span class="syntax-str">"q"</span>: q, <span class="syntax-str">"skip"</span>: skip, <span class="syntax-str">"limit"</span>: limit}

<span class="syntax-dec">@app.get</span>(<span class="syntax-str">"/items/"</span>)
<span class="syntax-kw">async def</span> <span class="syntax-fn">read_items</span>(
    commons: <span class="syntax-type">dict</span> = <span class="syntax-cls">Depends</span>(common_params)
):
    <span class="syntax-kw">return</span> commons
</pre>
</div>
</div>
...
<div class="flex flex-col items-center justify-center p-3 rounded bg-green-500/10 border border-green-500/20">
<span class="text-xl font-bold text-green-500 font-mono">200</span>
<span class="text-xs text-green-400 font-medium mt-1">OK</span>
</div>
<div class="flex flex-col items-center justify-center p-3 rounded bg-green-500/10 border border-green-500/20">
<span class="text-xl font-bold text-green-500 font-mono">201</span>
<span class="text-xs text-green-400 font-medium mt-1">Created</span>
</div>
<div class="flex flex-col items-center justify-center p-3 rounded bg-yellow-500/10 border border-yellow-500/20">
<span class="text-xl font-bold text-yellow-500 font-mono">400</span>
<span class="text-xs text-yellow-500 font-medium mt-1">Bad Request</span>
</div>
<div class="flex flex-col items-center justify-center p-3 rounded bg-yellow-500/10 border border-yellow-500/20">
<span class="text-xl font-bold text-yellow-500 font-mono">404</span>
<span class="text-xs text-yellow-500 font-medium mt-1">Not Found</span>
</div>
<div class="flex flex-col items-center justify-center p-3 rounded bg-red-500/10 border border-red-500/20">
<span class="text-xl font-bold text-red-500 font-mono">500</span>
<span class="text-xs text-red-500 font-medium mt-1">Server Error</span>
</div>
</div>
</div>
</div>
...
<span class="font-bold tracking-wide">PROMISE AYOBAMI NWHATOR</span>
<span class="mx-1 opacity-50">|</span>
<span>SYSTEMS ARCHITECT</span>
</div>
<div class="flex items-center gap-6">
<a class="hover:text-primary transition-colors" href="#">Twitter/X</a>
