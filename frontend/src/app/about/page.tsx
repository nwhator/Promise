...
<h1 class="text-xl font-bold text-slate-900 dark:text-white">Promise Ayobami Nwhator</h1>
<p class="mt-1 text-sm font-medium text-primary">Backend Engineer • WordPress Systems Architect</p>
<p class="mt-4 text-sm text-slate-600 dark:text-text-muted leading-relaxed">
...
<a class="group flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 dark:bg-border-dark text-slate-600 dark:text-text-muted transition-all hover:bg-primary hover:text-white" href="https://github.com/nwhator" target="_blank" rel="noreferrer">
<span class="material-symbols-outlined text-[20px]">code</span> <!-- Github metaphor -->
</a>
<a class="group flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 dark:bg-border-dark text-slate-600 dark:text-text-muted transition-all hover:bg-primary hover:text-white" href="https://linkedin.com/in/nwhator" target="_blank" rel="noreferrer">
<span class="material-symbols-outlined text-[20px]">work</span> <!-- LinkedIn metaphor -->
</a>
<a class="group flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 dark:bg-border-dark text-slate-600 dark:text-text-muted transition-all hover:bg-primary hover:text-white" href="mailto:nwhator@gmail.com">
...
<div class="flex items-center gap-3 text-sm text-slate-600 dark:text-text-muted mb-2">
...
<h2 class="text-4xl font-black tracking-tight text-slate-900 dark:text-white sm:text-5xl mb-6">
                                Structure drives growth.<br/>
<span class="text-slate-400 dark:text-slate-600">Performance keeps it sustainable.</span>
</h2>
<div class="prose prose-lg dark:prose-invert max-w-none text-slate-600 dark:text-text-muted">
<p>
...
<h4 class="mb-2 text-lg font-bold text-slate-900 dark:text-white">Clean Code</h4>
<p class="text-sm leading-relaxed text-slate-600 dark:text-text-muted">
...
<h4 class="mb-2 text-lg font-bold text-slate-900 dark:text-white">Performance First</h4>
<p class="text-sm leading-relaxed text-slate-600 dark:text-text-muted">
...
<h4 class="mb-2 text-lg font-bold text-slate-900 dark:text-white">Scalable Systems</h4>
<p class="text-sm leading-relaxed text-slate-600 dark:text-text-muted">
...
<div class="rounded-2xl border border-slate-200 dark:border-border-dark bg-slate-50 dark:bg-background-dark/50 p-6 md:p-8">
<div class="space-y-8">
<div>
...
<h4 class="text-lg font-bold text-slate-900 dark:text-white">BSc. Computer Science & Engineering</h4>
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1">
<h4 class="text-lg font-bold text-slate-900 dark:text-white">Certified Software Engineer - ALX</h4>
<span class="text-xs font-bold text-slate-500 bg-slate-100 dark:bg-border-dark px-2 py-1 rounded">Backend Engineering Program</span>
</div>
...
<span class="absolute -left-[5px] top-2 h-2.5 w-2.5 rounded-full bg-slate-300 dark:bg-slate-600 ring-4 ring-white dark:ring-background-dark"></span>
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1">
<h4 class="text-lg font-bold text-slate-900 dark:text-white">MyRESTful API Design Certified Solutions Architect</h4>
<span class="text-xs font-bold text-slate-500 bg-slate-100 dark:bg-border-dark px-2 py-1 rounded">2021</span>
</div>
...
<button class="w-full sm:w-auto px-8 py-3 bg-transparent border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-white font-bold rounded-lg hover:bg-slate-100 dark:hover:bg-border-dark transition-colors">
                                        View Portfolio
                                    </button>
</div>
</div>
