...
<!-- Header / Navigation -->
<header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 bg-surface dark:bg-surface-dark px-6 py-4 lg:px-10 sticky top-0 z-50">
...
<button class="flex items-center gap-2 text-slate-500 hover:text-foreground dark:text-slate-400 dark:hover:text-white transition-colors">
...
<!-- Mobile Menu Toggle -->
<button class="lg:hidden text-foreground dark:text-white">
...
<div>
<h1 class="text-3xl md:text-4xl font-black leading-tight tracking-[-0.033em] text-foreground dark:text-white">Invoicing &amp; Payments</h1>
...
<!-- Card 1 -->
<div class="flex flex-col gap-1 rounded-xl p-6 bg-surface dark:bg-surface-dark border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group">
...
<p class="text-foreground dark:text-white tracking-tight text-3xl font-bold mt-1">\$4,250.00</p>
...
<p class="text-foreground dark:text-white tracking-tight text-3xl font-bold mt-1">\$12,500.00</p>
...
<p class="text-foreground dark:text-white tracking-tight text-3xl font-bold mt-1">Oct 24, 2023</p>
...
<!-- Filters -->
<div class="flex flex-wrap items-center justify-between gap-4 bg-surface dark:bg-surface-dark p-4 rounded-lg border border-slate-200 dark:border-slate-800">
<div class="relative w-full sm:w-64">
<div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
<span class="material-symbols-outlined text-lg">search</span>
</div>
<input class="block w-full pl-10 pr-3 py-2 border border-slate-200 dark:border-slate-700 rounded-md leading-5 bg-surface dark:bg-surface-highlight text-foreground dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary sm:text-sm transition duration-150 ease-in-out" placeholder="Search invoice ID..." type="text"/>
</div>
<div class="flex gap-2">
<button class="flex items-center gap-2 px-3 py-2 bg-surface dark:bg-surface-highlight border border-slate-200 dark:border-slate-700 rounded-md text-sm font-medium text-slate-400 dark:text-slate-300 hover:text-primary hover:border-primary transition-colors">
...
<!-- Table Container -->
<div class="bg-surface dark:bg-surface-dark border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
<div class="overflow-x-auto custom-scrollbar">
<table class="min-w-full divide-y divide-slate-200 dark:divide-slate-800">
<thead class="bg-surface dark:bg-surface-highlight">
<tr>
...
<tbody class="bg-surface dark:bg-surface-dark divide-y divide-slate-200 dark:divide-slate-800">
<!-- Row 1 -->
<tr class="hover:bg-surface dark:hover:bg-surface-highlight transition-colors">
<td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-primary">
                                        #INV-3024
                                    </td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-400 dark:text-slate-300">
                                        Oct 01, 2023
                                    </td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-foreground dark:text-white font-medium">
                                        API Architecture Audit
                                    </td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-foreground dark:text-white font-bold">
                                        \$2,000.00
                                    </td>
...
<td class="px-6 py-4 whitespace-nowrap">
<span class="px-2.5 py-1 inline-flex text-xs leading-5 font-bold rounded-full bg-surface-brighter text-slate-800 dark:bg-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-600">
                                            Archived
                                        </span>
</td>
<td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
...
<!-- Pagination -->
<div class="bg-surface dark:bg-surface-highlight px-4 py-3 flex items-center justify-between border-t border-slate-200 dark:border-slate-800 sm:px-6">
...
<a class="relative inline-flex items-center px-2 py-2 rounded-l-md border border-slate-200 dark:border-slate-700 bg-surface dark:bg-surface-dark text-sm font-medium text-slate-500 hover:bg-surface dark:hover:bg-surface-highlight" href="#">
...
<a class="bg-surface dark:bg-surface-dark border-slate-200 dark:border-slate-700 text-slate-500 hover:bg-surface dark:hover:bg-surface-highlight relative inline-flex items-center px-4 py-2 border text-sm font-medium" href="#">
                                        2
                                    </a>
<a class="bg-surface dark:bg-surface-dark border-slate-200 dark:border-slate-700 text-slate-500 hover:bg-surface dark:hover:bg-surface-highlight relative inline-flex items-center px-4 py-2 border text-sm font-medium" href="#">
                                        3
                                    </a>
<a class="relative inline-flex items-center px-2 py-2 rounded-r-md border border-slate-200 dark:border-slate-700 bg-surface dark:bg-surface-dark text-sm font-medium text-slate-500 hover:bg-surface dark:hover:bg-surface-highlight" href="#">
...
<div class="bg-surface dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-800 p-6 flex flex-col gap-4">
<div class="flex items-center justify-between">
<h2 class="text-lg font-bold text-foreground dark:text-white">Payment Methods</h2>
...
<div class="bg-surface dark:bg-surface rounded p-1 h-8 w-12 flex items-center justify-center shadow-sm">
...
<div>
<p class="text-sm font-bold text-foreground dark:text-white">Visa ending in 4242</p>
...
<!-- Card Item 2 -->
<div class="group relative rounded-lg border border-slate-200 dark:border-slate-700 p-4 hover:bg-surface dark:hover:bg-surface-highlight transition-all">
<div class="flex items-start justify-between">
<div class="flex items-center gap-3">
<div class="bg-surface dark:bg-surface rounded p-1 h-8 w-12 flex items-center justify-center shadow-sm">
...
<div>
<p class="text-sm font-bold text-foreground dark:text-white">Mastercard ending in 8831</p>
...
<div class="bg-surface dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-800 p-6 flex flex-col gap-4">
<div class="flex items-center justify-between">
<h2 class="text-lg font-bold text-foreground dark:text-white">Billing Details</h2>
...
<div class="flex items-center gap-3">
<div class="size-8 rounded-full bg-surface-brighter dark:bg-surface-highlight flex items-center justify-center text-slate-500">
...
<span class="text-sm font-medium text-foreground dark:text-white">Acme Corp Ltd.</span>
</div>
</div>
<div class="flex items-center gap-3">
<div class="size-8 rounded-full bg-surface-brighter dark:bg-surface-highlight flex items-center justify-center text-slate-500">
...
<span class="text-sm font-medium text-foreground dark:text-white">billing@acmecorp.com</span>
</div>
</div>
<div class="flex items-center gap-3">
<div class="size-8 rounded-full bg-surface-brighter dark:bg-surface-highlight flex items-center justify-center text-slate-500">
...
<span class="text-sm font-medium text-foreground dark:text-white">123 Business Park, Suite 400<br/>San Francisco, CA 94107</span>
</div>
</div>
</div>
</div>
