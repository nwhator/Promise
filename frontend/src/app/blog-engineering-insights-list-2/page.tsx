...
export const metadata: Metadata = {
  title: 'Blog Engineering Insights List2 - PROMISE NWHATOR',
  description: 'Blog Engineering Insights List2 page for PROMISE NWHATOR.',
  alternates: {
    canonical: '/blog-engineering-insights-list-2',
  },
};

export default function BlogEngineeringInsightsList2() {
  const htmlContent = `
...
<div class="relative w-full max-w-lg transform overflow-hidden rounded-2xl bg-[#1b212d] border border-[#282d39] p-8 text-left shadow-2xl transition-all ring-1 ring-white/10 ring-offset-0 shadow-primary/10">
<button class="absolute right-4 top-4 rounded-full p-1 text-slate-400 hover:bg-white/5 hover:text-white transition-colors">
<span class="material-symbols-outlined !text-xl">close</span>
</button>
<div class="flex flex-col items-center text-center">
<div class="mb-5 flex size-14 items-center justify-center rounded-full bg-primary/10 text-primary ring-1 ring-primary/20">
<span class="material-symbols-outlined !text-3xl">mark_email_unread</span>
</div>
<h3 class="mb-2 text-2xl font-bold tracking-tight text-white sm:text-3xl">
                Level Up Your Engineering Skills
            </h3>
<p class="mb-8 text-slate-400">
                Join 5,000+ engineers. Get deep dives into FastAPI, Django, and system architecture delivered straight to your inbox.
            </p>
...
<input class="block w-full rounded-lg border border-[#282d39] bg-[#101622] py-3 pl-10 pr-4 text-white placeholder-slate-500 focus:border-primary focus:ring-1 focus:ring-primary sm:text-sm" placeholder="engineer@example.com" required="" type="email"/>
</div>
<button class="group relative flex w-full justify-center rounded-lg bg-primary px-4 py-3 text-sm font-bold text-white transition-all hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-[#1b212d] shadow-[0_0_20px_-5px_#1e60f1]" type="button">
                    Join the Newsletter
...
<p class="mt-4 text-xs text-slate-500">
                No spam, unsubscribe anytime. Read our <a class="text-slate-400 underline decoration-slate-600 hover:text-primary hover:decoration-primary" href="#">privacy policy</a>.
            </p>
</div>
<div class="absolute -top-24 -right-24 -z-10 h-64 w-64 rounded-full bg-primary/20 blur-[80px]"></div>
<div class="absolute -bottom-24 -left-24 -z-10 h-64 w-64 rounded-full bg-primary/10 blur-[80px]"></div>
</div>
</div>
